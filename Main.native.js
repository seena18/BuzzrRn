          ...
          <Pressable
            ...
            <View style={{ zIndex: 1, position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, justifyContent: 'center', alignItems: 'center' }}>
              ...
              <Animated.View style={[styles.buttonGreenlight, { top: shadow2height, left: shadow2width, opacity: shadow2opacity }]}>
                {shadow2opacity != 0 && <Svg height="100%" width="100%" >
                  <Defs>
                    <SVGRadialGradient
                      id="grad"
                      rx='30%'
                  ...
                  <Circle cx="50%" cy="50%" r={.20 * Dimensions.get('screen').height} fill="url(#grad)" />
                </Svg>}
                ...
                <Svg height="100%" width="100%" >
                  <Defs>
                    <SVGRadialGradient
                      ...
                      <Stop offset="1" stopColor="#e0e0e0" stopOpacity=".3" />
                    </SVGRadialGradient>
                  </Defs>
